 ...
 *
 * Links to advisors and reviewers, and the postings they suggest, live on the
 * Support page instead - neither is about this account's own data, the way
 * the sender block and the export below are.
 */
@Component({
  standalone: true,
